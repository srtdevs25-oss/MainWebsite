...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center hero-gradient overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium">NABL Accredited Laboratory</span>
          </motion.div>
          ...
          >
            Shree Radhey Technology provides quality calibration 
            services for testing & measuring instruments. An ISO/IEC 17025:2017 accredited by NABL for 
            Electro-Technical, Mechanical & Thermal Parameters since 2009.
          </motion.p>
          ...
          >
            {['ISO/IEC 17025:2017 Certified', '15+ Years Experience', 'NABL CC-2779'].map((feature) => (
